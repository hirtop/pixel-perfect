...
const SHOP_PRODUCTS_FALLBACK: ShopProduct[] = [
  ...
  // Shower Valve
  { id: "p52", category: "Shower Valve", brand: "Delta", name: 'R10000-UNBX Universal Mixing Rough-In Valve with 1/2" NPT Male Thread - Box Model', price: 52.90, image: "https://s3.img-b.com/image/private/t_base,c_pad,f_auto,dpr_2,w_450,h_450/product/delta/delta-r10000-unbx-798.jpg", url: "https://www.fergusonhome.com/delta-r10000-unbx/s661433?uid=188437", retailer: "Ferguson Home", bestFor: "Any Bath", featured: true },
  { id: "p53", category: "Shower Valve", brand: "Kohler", name: "Rite-Temp Pressure Balanced Rough-In Valve with Service Stops", price: 122.56, image: "https://s3.img-b.com/image/private/t_base,c_pad,f_auto,dpr_2,w_450,h_450/product/kohler/kohler-k-8304-us-na-1365168.jpg", url: "https://www.fergusonhome.com/kohler-k-8304-us-na/s1465281?uid=3446893", retailer: "Ferguson Home", bestFor: "Modern Bath" },
  { id: "p54", category: "Shower Valve", brand: "Moen", name: '1/2 Inch IPS Posi-Temp Pressure Balancing Rough-In Valve (No Stops)', price: 89.99, image: "https://s3.img-b.com/image/private/t_base,c_pad,f_auto,dpr_2,w_450,h_450/product/moen/moen-2510-62.jpg", url: "https://www.fergusonhome.com/moen-2510/s134202?uid=2553008", retailer: "Ferguson Home", bestFor: "Guest Bath" },
  // Tub Valve
  { id: "p55", category: "Tub Valve", brand: "Delta", name: "R4700-FL Floor Mounted Tub Filler Rough-In Valve", price: 259.00, image: "https://s3.img-b.com/image/private/t_base,c_pad,f_auto,dpr_2,w_450,h_450/product/delta/delta-r4700-fl-814.jpg", url: "https://www.fergusonhome.com/delta-r4700-fl/s889811?uid=2254372", retailer: "Ferguson Home", bestFor: "Master Bath", featured: true },
  { id: "p56", category: "Tub Valve", brand: "Delta", name: 'R4707 Roman Tub Filler Rough-In Valve with Handshower Connection', price: 256.38, image: "https://s3.img-b.com/image/private/t_base,c_pad,f_auto,dpr_2,w_450,h_450/product/delta/delta-r4707-784.jpg", url: "https://www.fergusonhome.com/delta-r4707/s661571?uid=188808", retailer: "Ferguson Home", bestFor: "Spa Bath" },
  { id: "p57", category: "Tub Valve", brand: "American Standard", name: 'R910 Flash Roman Tub Rough-In Valve Body with 1/2" Sweat Connection and Hand Shower Rough-In Kit', price: 233.35, image: "https://s3.img-b.com/image/private/t_base,c_pad,f_auto,dpr_2,w_450,h_450/product/americanstandard/american-standard-r910-9805719.jpg", url: "https://www.fergusonhome.com/american-standard-r910/s1562699?uid=3710535", retailer: "Ferguson Home", bestFor: "Any Bath" }
];
