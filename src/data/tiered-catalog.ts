...
export const tieredCatalog: TieredProduct[] = [
  ...
  {
    id: "bal-accent-02",
    name: 'Marble Pencil Rail Trim — 12" × ¾" (Allowance)',
    category: "Accent Tile",
    tier: "Balanced",
    vendor: "Ferguson — Marble Tile Trim",
    price: 10,
    estimatedProjectPrice: 120,
    description: "Slim marble pencil rail adds a refined edge around a niche or shower border. Final SKU selected at checkout from Ferguson's marble tile trim collection.",
    finish: "Marble (Honed or Polished — selectable)",
    spec: '~¾" × 12" marble pencil molding/rail; ~$10 per piece typical (~10 pieces / ~10 linear ft project allowance with waste)',
    isDefault: false,
    laborDelta: 80,
    laborNote: "Liner placement adds ~$80 labor",
    tag: "Elegant Detail",
    disclaimer: "Allowance only — Ferguson recently discontinued the MSI Carrara White pencil molding SKU. Link opens Ferguson's marble tile trim category so a comparable in-stock SKU can be selected. Price is an industry-typical estimate.",
    affiliateUrl: "https://www.fergusonhome.com/tile-molding-and-accessories/c116198?f19796=marble",
  },
  {
    id: "bal-accent-03",
    name: 'Daltile Sublimity — 11" × 11" Herringbone Honed Marble Mosaic',
    category: "Accent Tile",
    tier: "Balanced",
    vendor: "Daltile",
    price: 15.47,
    estimatedProjectPrice: 155,
    description: "Feature panel behind the vanity or inside the niche",
    finish: "Honed Marble — Namaste",
    spec: '11" × 11" mesh-mounted herringbone marble mosaic (model M072HERRINMS1U), sold by sheet (0.72 SF/sheet at ~$21.49/SF; ~6 sq ft feature area = ~9 sheets with waste)',
    isDefault: false,
    laborDelta: 150,
    laborNote: "Feature panel layout adds ~$150 labor",
    tag: "Trending",
    affiliateUrl: "https://www.fergusonhome.com/daltile-m0herrinmsu/s1751243",
    image: "https://s3.img-b.com/image/private/t_base,c_pad,f_auto,dpr_2,w_450,h_450/product/daltile/daltile-m072herrinms1u-727808.jpg",
  },
