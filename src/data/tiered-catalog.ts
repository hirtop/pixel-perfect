...
export const tieredCatalog: TieredProduct[] = [
  ...
  {
    id: "bal-accent-02",
    name: 'MSI Carrara White — 12" × ¾" Honed Marble Pencil Molding',
    category: "Accent Tile",
    tier: "Balanced",
    vendor: "MSI",
    price: 10,
    estimatedProjectPrice: 120,
    description: "Slim marble pencil molding adds a refined edge around a niche or shower border",
    finish: "Honed Carrara White Marble",
    spec: '¾" × 12" honed marble pencil molding (model SMOT-PENCIL-CARH), sold per piece (~10 pieces / ~10 linear ft project allowance with waste)',
    isDefault: false,
    laborDelta: 80,
    laborNote: "Liner placement adds ~$80 labor",
    tag: "Elegant Detail",
    affiliateUrl: "https://www.fergusonhome.com/msi-smot-pencil-h/s1661248",
  },
  {
    id: "bal-accent-03",
