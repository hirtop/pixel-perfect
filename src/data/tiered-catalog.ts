...
export const tieredCatalog: TieredProduct[] = [
  ...
  {
    id: "bal-accent-02",
    name: 'MSI Arabescato Carrara — 12" × ¾" Honed Marble Pencil Rail',
    ...
    spec: '12" × ¾" honed marble pencil rail, sold per piece (~10 linear ft project allowance with waste)',
    isDefault: false,
    laborDelta: 80,
  ...
  {
    id: "bal-accent-03",
    name: 'MSI Greecian White Herringbone — 12" × 12" Polished Marble Mosaic',
    category: "Accent Tile",
    tier: "Balanced",
    vendor: "MSI",
    price: 186,
    estimatedProjectPrice: 220,
    description: "Feature panel behind the vanity or inside the niche",
    finish: "Polished Greecian White Marble",
    spec: '12" × 12" mesh-mounted herringbone mosaic, sold by carton (9.4 SF/carton; ~6 sq ft feature area allowance, 1 carton + waste)',
    isDefault: false,
    laborDelta: 150,
