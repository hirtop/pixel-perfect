...
export const curatedFloorTiles: CuratedFloorTile[] = [
  ...
  {
    id: "modern-premium-backup2-tilebar-brooklyn-concrete-pearl-24x24",
    tier: "premium",
    style: "modern",
    category: "mainFloorTile",
    binRole: "backup2",
    productName:
      "TileBar Brooklyn Concrete Pearl 24 in. x 24 in. Matte Porcelain Floor and Wall Tile",
    cleanedDisplayName:
      "TileBar Brooklyn Concrete Pearl 24x24 Matte Porcelain",
    brand: "TileBar",
    retailer: "TileBar",
    productUrl:
      "https://www.tilebar.com/brooklyn-concrete-pearl-24x24-matte-porcelain-tile.html",
    imageUrl:
      "https://cdn.tilebar.com/media/catalog/product/b/r/brooklyn-concrete-pearl-24x24-matte.jpg",
    imageLicense: "retailer",
    priceUSDObserved: 10.99,
    priceUSDRegular: 10.99,
    priceCapturedDate: "2025-05-09",
    pricePerSqFtObserved: 10.99,
    pricePerSqFtRegular: 10.99,
    priceComputationNotes: "Retailer publishes price per sq ft.",
    tileMaterial: "porcelain",
    tileLook: "concrete-look",
    finish: "matte",
    colorFamily: "warm pearl gray",
    dimensions: "24 in. x 24 in.",
    thicknessMm: 10,
    indoorFloorRated: true,
    bathroomFloorRated: true,
    ...
    qualityNotes:
      "Rectified concrete-look porcelain from TileBar; PEI 4 per product page.",
    whyFitsThisTier:
      "Adds non-marble look diversity to Premium with a warm concrete-look 24x24 alternative to the marble-look primary and backup1.",
    replacementReason:
      "Replaced prior Premium backup2 marble-look SKU to break Premium white/gray marble-look monoculture.",
    caveats: "Large-format rectified tile; substrate flatness matters.",
    availabilityStatus: "in_stock",
    sku: "TB-BROOK-CONC-PEARL-2424M",
    modelNumber: "BROOK-CONC-PEARL-2424M",
    retailerCategory: "Porcelain Tile / Concrete Look",
    specSourceUrl:
      "https://www.tilebar.com/brooklyn-concrete-pearl-24x24-matte-porcelain-tile.html",
    manufacturerSpecSource:
      "tilebar.com (Brooklyn Concrete Pearl 24x24 matte)",
    isRealProduct: true,
    isPlaceholder: false,
  },
];
