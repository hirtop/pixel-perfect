...
export const curatedFaucets: CuratedFaucet[] = [
  ...
  {
    id: "modern-balanced-backup1-moen-s6910bl",
    tier: "balanced",
    style: "modern",
    category: "faucet",
    binRole: "backup1",
    productName:
      "Moen Doux Single Hole Single-Handle Bathroom Faucet in Matte Black",
    cleanedDisplayName: "Moen Doux Single-Hole Bathroom Faucet, Matte Black",
    brand: "Moen",
    retailer: "Home Depot",
    productUrl:
      "https://www.homedepot.com/p/MOEN-Doux-Single-Hole-Single-Handle-Bathroom-Faucet-in-Matte-Black-S6910BL/306756408",
    imageUrl:
    ...
    imageLicense: "retailer",
    priceUSDObserved: 318.99,
    priceUSDRegular: 318.99,
    priceCapturedDate: "2025-05-09",
    finish: "Matte Black",
    faucetType: "single-hole",
    compatibleHolePattern: "single-hole",
    ...
    drainIncluded: "unknown",
    valveIncluded: "unknown",
    requiresDeckPlate: "unknown",
    warrantyText: "Lifetime limited warranty",
    installationNotes: "Single-hole installation.",
    styleTags: ["modern", "architectural", "matte-black", "waterfall-spout"],
    qualityNotes: "Listing-level review count not captured in this session.",
    whyFitsThisTier:
      "Modern architectural waterfall-spout; alternate visual to Trinsic primary while staying single-hole and matte black.",
    replacementReason: null,
    caveats:
      "Faucet not included with vanity; purchased separately. Verify drain inclusion before install.",
    availabilityStatus: "in_stock",
    sku: "306756408",
    modelNumber: "S6910BL",
    retailerCategory: "Bathroom Sink Faucets / Single Hole",
    specSourceUrl:
      "https://www.homedepot.com/p/MOEN-Doux-Single-Hole-Single-Handle-Bathroom-Faucet-in-Matte-Black-S6910BL/306756408",
    manufacturerSpecSource: "moen.com (Doux S6910BL)",
    isRealProduct: true,
    isPlaceholder: false,
  },
